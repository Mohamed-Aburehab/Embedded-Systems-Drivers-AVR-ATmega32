...
void CLCD_voidSendCommand(u8 Copy_u8Command){
    ...
    CLCD_private_voidSetDataPortForHigherOrder(Copy_u8Command, CLCD_DATA_PORT,CLCD_DATA_PORT_PART);    
    // sent enable pulse
    DIO_u8SetPinValue(CLCD_CTRL_PORT, CLCD_E_PIN, DIO_u8PIN_HIGH);
    _delay_us(1);
    DIO_u8SetPinValue(CLCD_CTRL_PORT, CLCD_E_PIN, DIO_u8PIN_LOW);
    ...
    CLCD_private_voidSetDataPortForLowerOrder(Copy_u8Command, CLCD_DATA_PORT,CLCD_DATA_PORT_PART);    
    // sent enable pulse
    DIO_u8SetPinValue(CLCD_CTRL_PORT, CLCD_E_PIN, DIO_u8PIN_HIGH);
    _delay_us(1);
    DIO_u8SetPinValue(CLCD_CTRL_PORT, CLCD_E_PIN, DIO_u8PIN_LOW);
...
void CLCD_voidSendData(u8 Copy_u8Data){
    ...
    CLCD_private_voidSetDataPortForHigherOrder(Copy_u8Data, CLCD_DATA_PORT,CLCD_DATA_PORT_PART); 
    ...
    // set command Lower Order to data pins
    CLCD_private_voidSetDataPortForLowerOrder(Copy_u8Data, CLCD_DATA_PORT,CLCD_DATA_PORT_PART); 
    // sent enable pulse
    DIO_u8SetPinValue(CLCD_CTRL_PORT, CLCD_E_PIN, DIO_u8PIN_HIGH);
    _delay_us(1);
    DIO_u8SetPinValue(CLCD_CTRL_PORT, CLCD_E_PIN, DIO_u8PIN_LOW);
...
void CLCD_voidInit(void){
    ...
    //set RW pin to low for write
    DIO_u8SetPinValue(CLCD_CTRL_PORT, CLCD_RW_PIN, DIO_u8PIN_LOW);
    CLCD_private_voidSetDataPortForHigherOrder(0b00100010, CLCD_DATA_PORT,CLCD_DATA_PORT_PART);
    DIO_u8SetPinValue(CLCD_CTRL_PORT, CLCD_E_PIN, DIO_u8PIN_HIGH);
    _delay_us(1);
    DIO_u8SetPinValue(CLCD_CTRL_PORT, CLCD_E_PIN, DIO_u8PIN_LOW);
